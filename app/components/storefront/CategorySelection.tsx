...
import all from "@/public/earing.jpg";
import men from "@/public/diamond1.webp";
import women from "@/public/gold1.jpg";
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          ...
          <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href="/products/diamond">
              <h3 className="text-white font-semibold">Diamond Products</h3>
              <p className="mt-1 text-sm text-white">Shop Now</p>
            </Link>
          </div>
        </div>
        ...
        <div className="group aspect-w-2 aspect-h-1 rounded-lg overflow-hidden sm:relative sm:aspect-none sm:h-full">
          ...
          <div className="p-6 flex items-end sm:absolute sm:inset-0">
            <Link href="/products/gold">
              <h3 className="text-white font-semibold">Gold Products</h3>
              <p className="mt-1 text-sm text-white">Shop Now</p>
            </Link>
          </div>
        </div>
